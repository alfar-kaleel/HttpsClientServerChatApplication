...
public class ClientChat {
	  ...
	  private static String ip = "localhost", name = "alfar", port = "8090";
	  ...
	  public static void main(String[] args) throws Exception {
	    ...
	    if (matches.find()) {
	      ...
	      String httpsURL = "https://" + ip + ":" + port + "/registerUser?name=" + name;
	      ...
	      new Thread(() -> {
	        while (true) {
	          ...
	          try {
	            Thread.sleep(4000);
	            String httpsURL1 = "https://127.0.0.1:8090/showInbox?name=" + name;
	  ...
	  private static void sendToServer(String sendToServer) {
	    try {
	      ...
	      if (matcher2.find()) {
	        ...
	        String httpsURL1 = "https://127.0.0.1:8090/sendMessage?message=" + message.trim()
	  ...
	  private static void getList() {
	    try {
	      ...
	      String httpsURL1 = "https://127.0.0.1:8090/listUsers?name=" + name;
	      URL myUrl1 = new URL(httpsURL1);
	      HttpsURLConnection conn1 = (HttpsURLConnection) myUrl1.openConnection();
